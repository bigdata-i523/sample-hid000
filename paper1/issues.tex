...
\TODO{Have you speciﬁed proper identiﬁcation in the README.md ﬁle?}
...
\TODO{Have you spell-checked the paper?}
\TODO{Are you using “a“ and “the“ properly?}
...
\TODO{In case you copied a ﬁgure from another paper you need to ask for copyright permission. In case of a class paper you must include a reference to the original in the caption.}
...
\TODO{Do not use the characters \& \# \% \_ put a backslash before them}
...
\TODO{Figures should be reasonably sized and often you just need to add \verb|[width=\columnwidth]|}
